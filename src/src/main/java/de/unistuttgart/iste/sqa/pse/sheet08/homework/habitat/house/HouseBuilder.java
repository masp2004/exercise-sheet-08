...
public final class HouseBuilder {
	 ...
	 * @throws IllegalArgumentException if the new wall is null or overlaps with any of the already planned walls.
	 * @throws NullPointerException     if the new wall is null.
	 */
	public HouseBuilder withWall(final HouseWall wall) {
		if (wall == null) {
			throw new NullPointerException("New house wall must not be null.");
		}
	 ...
	 * @throws IllegalStateException if the walls are empty or if any of the tiles
	 */
	public House build() {
		if (walls.isEmpty()) {
