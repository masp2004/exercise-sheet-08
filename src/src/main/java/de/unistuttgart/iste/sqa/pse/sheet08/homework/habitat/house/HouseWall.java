...
public final class HouseWall {
	 ...
	 * @throws IllegalArgumentException if either start or end are null, if start is not closer to the origin than end, or if start and end are not in line.
	 ...
	 * @throws NullPointerException	 if {@code newDoor} is null.
	 * @throws IllegalArgumentException if {@code newDoor} is not a valid door, or if the housewall already has a door.
	 */
